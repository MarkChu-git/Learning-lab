...
- Typora 写作与设置
- 图片、目录、相对路径、仓库组织
- Markdown / CommonMark / GFM 差异
- LaTeX 公式基础与文档表达

当前入口：

- [分册说明](books/typora-and-markdown/README.md)
- [第零章：新手快学版——先把 Typora、Markdown、LaTeX 真正用起来](books/typora-and-markdown/chapters/00-practical-quickstart.md) ([English](books/typora-and-markdown/chapters/00-practical-quickstart.en.md))
...
- 英文版不再只做“简略入口页”
- 中英文目标是信息量尽量一致，只语言不同
- 快学版与完整正文两条线都要在中英文同时维护

## D. 编写原则

- **独立成立**：单册可单独阅读。
- **支持长期扩写**：结构可持续扩展。
- **可回溯依据**：关键判断可追溯到官方或原始资料。
- **真正可学**：强调可理解、可实操、可复习。
